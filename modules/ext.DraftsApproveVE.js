...
function changeSaveButtonText() {
    ...
    new MutationObserver(changeSaveButtonTextMobile).observe(document.querySelector('#mw-teleport-target .ve-ui-mobileWindowManager'), {childList: true, subtree: true});
}
